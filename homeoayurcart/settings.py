...
ACCOUNT_USERNAME_REQUIRED = True  # Username is required for phone.email users
...
ACCOUNT_AUTHENTICATION_METHOD = 'username_email'  # Set the default authentication method
...
# Cashfree settings
CASHFREE_API_ID = env('CASHFREE_API_ID')
